...
const titleistDrivers = [
  { id: 1, name: 'TSR2 9.5도 TSP322 55 SR', price: '가격문의', image: null, description: '타이틀리스트 TSR2 드라이버입니다. 뛰어난 관용성과 비거리를 제공하는 최신 모델입니다.', stock: 2 },
  { id: 2, name: 'TSR3 9도 TSP110 60 S', price: '가격문의', image: null, description: '타이틀리스트 TSR3 드라이버입니다. 투어 프로들이 선호하는 정밀한 컨트롤을 제공합니다.', stock: 1 },
  { id: 3, name: 'TSi2 10.5도 TSP322 55 R', price: '가격문의', image: null, description: '타이틀리스트 TSi2 드라이버입니다. 관용성과 비거리를 동시에 제공하는 고성능 드라이버입니다.', stock: 3 },
  { id: 4, name: 'TSi3 9.5도 TENSEI CK Pro Orange 70 S', price: '가격문의', image: null, description: '타이틀리스트 TSi3 드라이버입니다. 정밀한 컨트롤과 뛰어난 성능을 자랑합니다.', stock: 2 },
  { id: 5, name: 'TS2 10.5도 Tour AD 60 SR', price: '가격문의', image: null, description: '타이틀리스트 TS2 드라이버입니다. 높은 관용성으로 다양한 골퍼에게 적합합니다.', stock: 1 },
  { id: 6, name: 'TS3 9도 TENSEI CK Pro Orange 70 S', price: '가격문의', image: null, description: '타이틀리스트 TS3 드라이버입니다. 투어 수준의 성능을 제공합니다.', stock: 2 },
  { id: 7, name: '917D2 10.5도 Diamana D+ 70 S', price: '가격문의', image: null, description: '타이틀리스트 917D2 드라이버입니다. 클래식한 디자인과 현대적 성능의 조화입니다.', stock: 0 },
  { id: 8, name: '915D2 9.5도 Tour AD DI-7 S', price: '가격문의', image: null, description: '타이틀리스트 915D2 드라이버입니다. 검증된 성능의 드라이버입니다.', stock: 1 },
  { id: 9, name: 'TSR1 10.5도 TSP322 45 A', price: '가격문의', image: null, description: '타이틀리스트 TSR1 드라이버입니다. 고관용성 설계로 쉬운 플레이를 제공합니다.', stock: 3 },
  { id: 10, name: 'TSi1 12도 TSP322 45 L', price: '가격문의', image: null, description: '타이틀리스트 TSi1 드라이버입니다. 가벼운 설계로 편안한 스윙이 가능합니다.', stock: 2 }
];

export default function TitleistDriverProductPage() {
  ...
  // 해당 ID의 타이틀리스트 드라이버 상품 찾기
  const product = titleistDrivers.find(p => p.id === productId);
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">요청하신 타이틀리스트 드라이버 상품이 존재하지 않습니다.</p>
        </div>
      </div>
    );
  }
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white p-4 rounded border-l-4 border-blue-500">
                <h4 className="font-semibold text-gray-800 mb-2">타이틀리스트 드라이버 특징</h4>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• 투어 프로들이 검증한 높은 성능</li>
                  <li>• 정밀한 컨트롤과 일관된 비거리</li>
                  <li>• 프리미엄 소재와 정교한 설계</li>
                  <li>• PGA 투어에서 가장 많이 사용되는 브랜드</li>
                </ul>
              </div>
              ...
              <div className="border-t pt-4 mt-6">
                ...
                <div className="grid grid-cols-2 gap-y-2 text-sm">
                  ...
                  <div className="flex justify-between border-b border-gray-200 pb-1">
                    ...
                    <span className="font-medium">고강도 티타늄</span>
                  </div>
                  <div className="flex justify-between border-b border-gray-200 pb-1">
                    <span className="text-gray-600">로프트각:</span>
                    <span className="font-medium">9.5도</span>
                  </div>
                  <div className="flex justify-between border-b border-gray-200 pb-1">
                  ...
                  <div className="flex justify-between border-b border-gray-200 pb-1">
                    ...
                    <span className="font-medium">45.25인치</span>
                  </div>
                  <div className="flex justify-between border-b border-gray-200 pb-1">
