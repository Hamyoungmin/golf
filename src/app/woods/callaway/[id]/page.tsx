...
// 캘러웨이 우드 상품 데이터
const callawayWoods = [
  { id: 1, name: 'PARADYM 15도 Project X HZRDUS Smoke IM10 60', price: '가격문의', image: null, description: '캘러웨이 PARADYM 우드입니다. 혁신적인 기술과 뛰어난 성능을 제공하는 최신 모델입니다.', stock: 2 },
  { id: 2, name: 'ROGUE ST MAX 15도 Fujikura VENTUS Blue 6 R', price: '가격문의', image: null, description: '캘러웨이 ROGUE ST MAX 우드입니다. 최대한의 관용성을 제공하는 고성능 우드입니다.', stock: 1 },
  { id: 3, name: 'EPIC MAX LS 15도 Project X HZRDUS Smoke IM10', price: '가격문의', image: null, description: '캘러웨이 EPIC MAX LS 우드입니다. 로우 스핀으로 최대 비거리를 실현합니다.', stock: 3 },
  { id: 4, name: 'EPIC SPEED 15도 Diamana 50 for Callaway S', price: '가격문의', image: null, description: '캘러웨이 EPIC SPEED 우드입니다. 스피드와 파워를 극대화하는 우드입니다.', stock: 2 },
  { id: 5, name: 'MAVRIK LITE 20.5도 Diamana 40 for Callaway L', price: '가격문의', image: null, description: '캘러웨이 MAVRIK LITE 우드입니다. 경량 설계로 편안한 스윙이 가능합니다.', stock: 1 },
  { id: 6, name: 'MAVRIK 15도 4 SR', price: '가격문의', image: null, description: '캘러웨이 MAVRIK 우드입니다. 뛰어난 성능과 안정성을 제공합니다.', stock: 2 },
  { id: 7, name: 'ROGUE STAR 15도 Speeder EVOLUTION R', price: '가격문의', image: null, description: '캘러웨이 ROGUE STAR 우드입니다. 검증된 성능의 우드입니다.', stock: 0 },
  { id: 8, name: 'XR16 FAIRWAY 15도 SR', price: '가격문의', image: null, description: '캘러웨이 XR16 페어웨이 우드입니다. 클래식한 디자인의 우드입니다.', stock: 3 },
  { id: 9, name: 'EPIC MAX FAST 15도 R FAST Driver Speeder Evolution', price: '가격문의', image: null, description: '캘러웨이 EPIC MAX FAST 우드입니다. 빠른 스윙 스피드에 최적화되었습니다.', stock: 1 },
  { id: 10, name: 'ROGUE ST MAX FAST 15도 S Speeder NX 40', price: '가격문의', image: null, description: '캘러웨이 ROGUE ST MAX FAST 우드입니다. 고성능과 관용성을 제공합니다.', stock: 2 }
];

export default function CallawayWoodProductPage() {
  ...
  // 해당 ID의 캘러웨이 우드 상품 찾기
  const product = callawayWoods.find(p => p.id === productId);
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">요청하신 캘러웨이 우드 상품이 존재하지 않습니다.</p>
        </div>
      </div>
    );
  }
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white p-4 rounded border-l-4 border-blue-500">
                <h4 className="font-semibold text-gray-800 mb-2">캘러웨이 우드 특징</h4>
              ...
              <div className="border-t pt-4 mt-6">
                ...
                <div className="grid grid-cols-2 gap-y-2 text-sm">
                  ...
                  <div className="flex justify-between border-b border-gray-200 pb-1">
                    ...
                    <span className="font-medium">180cc</span>
                  </div>
                  <div className="flex justify-between border-b border-gray-200 pb-1">
                    <span className="text-gray-600">클럽 길이:</span>
                    <span className="font-medium">43인치</span>
                  </div>
                  <div className="flex justify-between border-b border-gray-200 pb-1">
